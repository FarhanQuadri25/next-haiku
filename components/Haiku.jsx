  ...
  return (
    <div className="relative rounded-xl overflow-hidden max-w-[650px] mx-auto mb-7">
      ...
      <div className="absolute bottom-2 flex right-2">
        <Link
          className="inline-block mr-1 bg-black/40 hover:bg-black/50 p-2 text-white/60 hover:text-white/80 rounded"
        ...
        <form action={deleteHaiku}>
          ...
          />
          <button className="block bg-black/40 hover:bg-black/50 p-2 text-white/60 hover:text-white/80 rounded ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 16 16"
              fill="currentColor"
