...
function isAlphaNumericWithBaics(text) {
...
async function sharedHaikuLogic(formData, user) {
  ...
  // Debugging: Log each line's value
  console.log("line1:", ourHaiku.line1);
  console.log("line2:", ourHaiku.line2);
  console.log("line3:", ourHaiku.line3);

  // Check syllable count (length of the line)
  ...
  // Check for special characters (function now returns true if there's a special char)
  ...
  if (ourHaiku.line1.length == 0) errors.line1 = "The field is required";
  if (ourHaiku.line2.length == 0) errors.line2 = "The field is required";
  if (ourHaiku.line3.length == 0) errors.line3 = "The field is required";
